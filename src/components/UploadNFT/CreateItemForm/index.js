      ...
      <CreateItemFormContainer>
        ...
        <CreateItemFormDetails>
          ...
          <ItemWrapper>
            ...
            <Select
              notReload
              placeholder={<Option>Select Collection</Option>}
          ...
          </ItemWrapper>
          {
            categoryOptionsLevel0.length > 0 && <ItemWrapper>
              ...
              <Select
                notReload
                placeholder={<Option>Select Top-Level Category</Option>}
          ...
          }
          {
            categoryOptionsLevel1.length > 0 && <ItemWrapper>
              ...
              <Select
                notReload
                placeholder={<Option>Select Depth-1 Category</Option>}
          ...
          }
          {
            categoryOptionsLevel2.length > 0 && <ItemWrapper>
              ...
              <Select
                notReload
                placeholder={<Option>Select Depth-2 Category</Option>}
          ...
          }
          {
            categoryOptionsLevel3.length > 0 && <ItemWrapper>
              ...
              <Select
                notReload
                placeholder={<Option>Select Depth-3 Category</Option>}
          ...
          }
          {
            categoryOptionsLevel4.length > 0 && <ItemWrapper>
              <label>Select Depth-4 Category</label>
              <Select
                notReload
                placeholder={<Option>Select Depth-4 Category</Option>}
