...
const MakeOfferModal = (props) => {
  ...
  const priceTypeList = [
    ...
    // { id: 2, name: 'HyperX', key: 'HyperX', icon: theme.images.chainTokenIcon },
  ]
          ...
          <MakeOfferDetailContainer>
            <div className='balance-frame'>
              <div className='balance-item'>
                <div className="owner-title">Select owner</div>
            ...
            <div className="price-title">Price per Item</div>
            ...
            <div className="price-description">
              <p>Total amount offered: {price} {selectedPriceType.name} = {convertPrice && convertPrice(selectedPriceType.id, price)} USD</p>
            </div>
            <div className="price-title">Offer Expiration</div>
            ...
            <div className="temrs-container">
              <CheckBox
                id={1}
                label={'By checking this box, I agree to HyperX’s Terms of service'}
