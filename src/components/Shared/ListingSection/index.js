...
import { EmptyActivityIcon, ActionCheckIcon, ActionCloseIcon, TicketIcon } from '../SvgIcons';
...
const ListingSection = () => {
  ...
  const filterList = [
    { key: 'all', name: 'ALL' },
    { key: 'direct_sales', name: 'DIRECT SALES' },
    { key: 'auctions', name: 'AUCTIONS' }
  ]
  ...
  return (
    <OfferSectionContainer>
      <OfferSectionHeader>
        <TitleWrapper>
          <TicketIcon />
          <div className="header-text">Listing</div>
        </TitleWrapper>
        <FilterWrapper>
          {filterList.map(item => (
            <GradientButton
